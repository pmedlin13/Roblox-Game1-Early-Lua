...
local function onJumpRequest()
	if (not humanoid or humanoid:GetState() == Enum.HumanoidStateType.Dead) or player.stats.Participate.Value == true then
		return;
	end
...
local function TourneyStarting()
	if player.stats.Participate.Value == true then
		setFlying(false)
	end
end
...
player.stats.Participate.Changed:Connect(TourneyStarting)
