local ods = game:GetService("DataStoreService"):GetOrderedDataStore("Rebirth")
...
while true do
	...
	local success, message = pcall(function()
		...
		updateBoard(game.Workspace.RebirthLeaderboard.Top5ScoreBoard, data)
		...
		if not pages.IsFinished then			
			...
			updateBoard(game.Workspace.RebirthLeaderboard.Next5ScoreBoard, data)
		end
	end)
