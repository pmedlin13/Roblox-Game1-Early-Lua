...
Grips = {
	Up = CFrame.new(0, -2, 0, 1, 0, -0, 0, 1, 0, 0, -0, 1),
	Out = CFrame.new(0, -2, 0, 1, 0, 0, 0, 0, -1, -0, 1, 0)
}
...
function Blow(Hit)
	...
	local StrengthDamage = stats.Strength.Value / 500
	humanoid:TakeDamage(StrengthDamage)	
end
