...
local Mode = script.Parent:WaitForChild("InputHandler"):WaitForChild("SuperSaiyanB")
...
local function SSJ()
  ...
  Function.WeldHair(Hair.SSJB, Head, Particles.SSJB, Torso)
  Run = true
  On = true
  Mode.Value = true
end
...
Player.Chatted:connect(function(MSG)
  local MSG = MSG:lower()
  if MSG:sub(1, 5) == "ssjb" or MSG:sub(1, 8) == "/e ssjb" then
    SSJ()
